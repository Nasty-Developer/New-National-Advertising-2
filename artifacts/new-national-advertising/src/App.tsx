      ...
      <main className="pt-[70px]">
        <section className="border-b border-[#e4ebf0] bg-[#f3f7f8]">
          <div className="container-nna py-16 sm:py-20 lg:py-24">
            ...
            <p className="mt-6 max-w-[610px] text-[15px] leading-7 text-[#607487]">Browse the complete New National Advertising catalogue by category. Every item shown here is published from the studio workspace.</p>
          </div>
        </section>
