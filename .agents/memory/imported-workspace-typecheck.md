...
**How to apply:** After importing or changing generated shared libraries, run the root library typecheck, then the full workspace typecheck, before presenting the app.
