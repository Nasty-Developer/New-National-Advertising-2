...
export const GetProductCategoriesResponseItem = zod.object({
  ...
  "categoryImagePath": zod.string().nullable(),
  "categoryImageUrl": zod.string().nullable(),
  "categoryImageAlt": zod.string().nullable(),
  "active": zod.boolean(),
 ...
 */
export const updateAdminProductCategoryPathIdMax = 100;



export const UpdateAdminProductCategoryParams = zod.object({
  "id": zod.coerce.string().min(1).max(updateAdminProductCategoryPathIdMax)
})

export const updateAdminProductCategoryBodyCategoryImagePathMax = 500;

export const updateAdminProductCategoryBodyCategoryImageAltMax = 180;



export const UpdateAdminProductCategoryBody = zod.object({
  "categoryImagePath": zod.string().max(updateAdminProductCategoryBodyCategoryImagePathMax).nullable(),
  "categoryImageAlt": zod.string().max(updateAdminProductCategoryBodyCategoryImageAltMax).nullable()
})

export const UpdateAdminProductCategoryResponse = zod.object({
  "categoryId": zod.string(),
  "categoryName": zod.string(),
  "categoryImagePath": zod.string().nullable(),
  "categoryImageUrl": zod.string().nullable(),
